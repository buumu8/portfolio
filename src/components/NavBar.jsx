  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-gray-900 text-gray-100 shadow-md p-4 md:mb-0 mb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
        ...
        {/* Menu Links */}
        <div
          className={`flex flex-col md:flex-row md:items-center w-full md:w-auto overflow-hidden transition-all duration-300 ${
            isOpen ? "max-h-64" : "max-h-0 md:max-h-full"
          }`}
        >
          ...
          <Link to="/certifications" className="py-2 md:py-0 md:mx-2 hover:text-gray-300" onClick={() => setIsOpen(false)}>
